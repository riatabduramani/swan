...
<input type="file" onclick="importLibrary()" id="attach" rel="external" placeholder="Attach" name="attach" class="" accept="image/jpg,image/jpeg,image/gif,image/png" capture required/>
<?php } else { ?>
 <input type="file" id="attach" rel="external" placeholder="Attach" name="attach" class="" required/>
 <?php  } ?>   
