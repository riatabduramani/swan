        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">Packet</div>
                    <div class="panel-body">
                        <a href="{{ url('/admin/packet/create') }}" class="btn btn-success btn-sm" title="Add New packet">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        {!! Form::open(['method' => 'GET', 'url' => '/admin/packet', 'class' => 'navbar-form navbar-right', 'role' => 'search'])  !!}
